...
-- Q5 : Who is the best customer ? the customer who has spqnt the most money will be declared the best customer.Write a 
-- query that returns the person whose has spent the most money.
...
-- Q6: write a query to return the email,first name, last name and Genre of all Rock Music listeners.Return your list ordered
